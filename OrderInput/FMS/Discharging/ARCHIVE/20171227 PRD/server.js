        ...
        goods.push(
          {
            ...
            ExtraQuantities: [
              {
                "UnitCode": "Net",
                "Quantity": parseFloat(value[COL_NETT]),
                "MeasurementUnitCode": "KG",
                "Recalculate": null
              },
              {
                "UnitCode": "Gross",
                "Quantity": parseFloat(value[COL_GROSS]),
                "MeasurementUnitCode": "KG",
                "Recalculate": null
              }
            ],
            Sids: [
              ...
              },
              {
                ...
                "Value": value[COL_DIAMETER]
              },
              {
                "Code": "GRM", // Grammage - Number
                "Value": value[COL_GRAMMAGE]
              },
              {
