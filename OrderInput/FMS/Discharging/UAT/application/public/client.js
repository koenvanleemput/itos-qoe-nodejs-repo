...
$(function() {
  ...
  function(err, results) {
      ...
      packinglist = new Handsontable(pl, {
        ...
        columns: [
          ...
          {title: "Diameter<sup />", type: 'numeric', format: '0'},
          {title: "Grammage<sup />", type: 'numeric', format: '0.00'},
          ...
          {title: "Core Code<sup />"},
          {title: "Diameter Core<sup />", type: 'numeric', format: '0'},
          {title: "Color<sup />"},
  ...
  $('form#oi').submit(function(event) {
    ...
    if ((fdata.custcode === undefined || fdata.custcode === null || fdata.custcode === '') ||
      ...
      alert("Please fill in FMS Order Number, Lot AND Sequence!");
      return;
    }
