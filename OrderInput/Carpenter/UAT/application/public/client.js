...
$(function() {
  ...
  const COL_CAT = 1;            // Category => SP "CAT"
  ...
  const COL_ENDCLIENT = 5;      // End Client
  const COL_INSTRUCTIONS = 6;   // Instructions
  ...
  function(err, results) {
    ...
    hot = new Handsontable(container, {
      ...
      columns: [
                ...
                {title: "Category", type:'dropdown', source: ['CARPENTER', 'DYNAMET', 'LATROBE'], width: 100}, // Stock Property CAT
                ...
                {title: "Instructions", type: 'dropdown', source: results.instructions, width: 160}, // Stock Prop WHS_INT
  ...
  */
  ...
  $('input#order-contno').focusout(function (event) {
      event.preventDefault();
      $('a#retrieve').trigger("click");
  });
...
var retrieveFormData = function(fdata, hot) {
  ...
  var url = "/entries/" + fdata.custcode + "/" + fdata.extid + "/" + fdata.contno;
